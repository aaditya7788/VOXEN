...
export default function SecondarySidebar({ visible = true, space, activeView = "proposals", onNavigate, isHomeView = false, onToggle, isMobileOpen = false, refreshKey = 0, userSpaces = [], onSpaceDeleted }: SecondarySidebarProps) {
  ...
  return (
    ...
    {/* Toast Notification */}
    {toast && (
      <div className={`fixed top-6 left-4 right-4 sm:right-6 sm:left-auto px-4 py-3 rounded-lg shadow-lg z-50 animate-in fade-in slide-in-from-top-2 duration-300 flex items-center gap-2 ${
        toast.type === 'success' 
